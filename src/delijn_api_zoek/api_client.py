...
from delijn_api_zoek import rest
from delijn_api_zoek.configuration import Configuration
from delijn_api_zoek.exceptions import ApiTypeError, ApiValueError, ApiException
from delijn_api_zoek.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = ZoekenApi()
        api_instance.zoek_haltes  # this is an instance of the class Endpoint
        api_instance.zoek_haltes()  # this invokes api_instance.zoek_haltes.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.zoek_haltes.callable or self.callable in this class
