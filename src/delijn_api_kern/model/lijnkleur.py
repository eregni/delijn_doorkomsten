...
class Lijnkleur(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, omschrijving, rgb, hex, *args, **kwargs):  # noqa: E501
        """Lijnkleur - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, omschrijving, rgb, hex, *args, **kwargs):  # noqa: E501
        """Lijnkleur - a model defined in OpenAPI
