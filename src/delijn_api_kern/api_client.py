...
from delijn_api_kern import rest
from delijn_api_kern.configuration import Configuration
from delijn_api_kern.exceptions import ApiTypeError, ApiValueError, ApiException
from delijn_api_kern.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = DistrictenApi()
        api_instance.geef_district  # this is an instance of the class Endpoint
        api_instance.geef_district()  # this invokes api_instance.geef_district.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.geef_district.callable or self.callable in this class
