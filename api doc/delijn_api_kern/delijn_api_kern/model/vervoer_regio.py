...
class VervoerRegio(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, naam, nr, *args, **kwargs):  # noqa: E501
        """VervoerRegio - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, naam, nr, *args, **kwargs):  # noqa: E501
        """VervoerRegio - a model defined in OpenAPI
